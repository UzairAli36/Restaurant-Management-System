...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO cart (item_id, name, price, quantity, image, user_id) VALUES (:item_id, :name, :price, :quantity, :image, :user_id)";
        $arr = [
            ":item_id" => $item_id,
            ":name" => $name,
            ":price" => $price,
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <form method="POST" action="add-cart.php?id=<?php echo $id; ?>">
                    ...
                    <input name="quantity" class="form-control" type="number" min="1" data-bts-button-down-class="btn btn-primary" data-bts-button-up-class="btn btn-primary" value="1" name="vertical-spin">
                    <?php if (isset($_SESSION['user_id'])) : ?>
                        ...
                        <?php endif; ?>
                    <?php else : ?>
                        <h4 style="font-family: 'Pacifico', cursive; color: #FEA116 !important; position: relative; display: inline-block;">Login to add to cart</h4>
                    <?php endif; ?>
                </form>
            </div>
        </div>
